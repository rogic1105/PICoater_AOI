    ...
    public class InspectionLogServiceTests
    {
        ...
        public void AppendRecord_ConfigChange_InsertNewCfg()
        {
            ...
            var config1 = new CsvConfigSnapshot(
                new double[] { 1, 2, 3, 4, 5, 6, 7 }, new double[7], null, null, null, 1.0f, 0.5f, 0.8f, 0.5f, 0.8f, 0.0, 0.0, ts);
            var config2 = new CsvConfigSnapshot(
                new double[] { 10, 20, 30, 40, 50, 60, 70 }, new double[7], null, null, null, 2.0f, 0.6f, 0.9f, 0.6f, 0.9f, 0.0, 0.0, ts);
