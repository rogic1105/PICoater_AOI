...
namespace TanukiCv.Controls
{
    ...
    /// </summary>
    public class ImageDisplayView : IDisposable
    {
        ...
        /// <summary>游標狀態快照（單一來源＝ImageDisplayView 內部 mm 換算；上層不重算）。</summary>
        ...
        public ImageDisplayView(Panel mainPanel, Panel[] camPanels, double screenMmPerPx)
        {
