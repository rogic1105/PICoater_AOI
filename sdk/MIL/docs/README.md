...
- **[`multicam-regrab-frame-alignment.md`](multicam-regrab-frame-alignment.md)** — 多相機 **free-run** 取像
  re-grab 起頭錯位與停止尾幀的根因，以及現行 **hot standby + 全域產品收幀 gate**；
  實體 drain 只留給重配置／Release。改 grab 啟停前必讀。
