...
| `sdk/TanukiCv/dotnet/TanukiCv.Controls/Interaction/MultiClickDetector.cs` | **多擊偵測器（已搬 sdk 共用唯一來源）**：SmartCanvas 雙擊 fit/三擊 1:1 與 app `camLiveMain` panel route 共用；呼叫端可設定 interval/距離模式保留原手勢語意。 |
