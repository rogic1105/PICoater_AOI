namespace AniloxRoll.Monitor.Core.Data
{
    ...
    internal static class InspectionDefaults
    {
        ...
        public static readonly ColumnCurveDisplayMode ColumnCurveMode = ColumnCurveDisplayMode.Both; // 欄列曲線顯示；欄檢出判定
        ...
        public const EnhanceHeatmapMode EnhanceHeatmap = EnhanceHeatmapMode.Off; // 強化圖主畫面熱力圖
        ...
        public const string RemotePath        = @"\\192.168.10.20\Anilox\Captures";
